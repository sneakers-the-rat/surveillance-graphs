...
\href{https://jon-e.net/surveillance-graphs/data/ROBOKOP_message.json}{a query for genes associated with} gender
...
the near-monopoly\sidenote[][-1.5in]{The last major competitor being Firefox with
  market share in the low teens. Hang in there little fox!} of
Chrome\sidenote[][-1in]{Which Google uses as a surveillance platform and a
...
not a bug\sidenote[][-2in]{\begin{leftbar}
...
Koller\sidenote[][-0.9in]{Language modeling research has developed its own ad-hoc
...
in front of me\sidenote[][-1in]{Again, it is the combination of large machine
...
recommendation product\sidenote{Medical algorithms are currently in a
  ...
  protections is patchy at best \cite{olivaDosingDiscriminationRegulating2021, ordishAlgorithmsMedicalDevices2019, el-sayedMedicalAlgorithmsNeed2021} }. We could allow our model to be conditioned by that data, but
